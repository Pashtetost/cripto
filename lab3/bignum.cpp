...
void bignum_fromhex(bignum_digit_t* num,const char* str, int digits) {
...
/* присвоить числу максимальное значение */
void bignum_setmax(bignum_digit_t* num, int digits) {
  memset(num, 0xFF, BIGNUM_SIZE(digits));
}
